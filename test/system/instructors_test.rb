...
class InstructorsTest < ApplicationSystemTestCase
  ...
  test "creating a Instructor" do
    ...
    fill_in "Firstname", with: @instructor.firstName
    fill_in "Instructorid", with: @instructor.instructorId
    fill_in "Lastname", with: @instructor.lastName
    fill_in "Middlename", with: @instructor.middleName
