...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { email: @instructor.email, firstName: @instructor.firstName, instructorId: @instructor.instructorId, lastName: @instructor.lastName, middleName: @instructor.middleName } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { email: @instructor.email, firstName: @instructor.firstName, instructorId: @instructor.instructorId, lastName: @instructor.lastName, middleName: @instructor.middleName } }
